...
export default function SuffixInput(props: SuffixInputProps) {
    const { label, suffix, className, suffixClassName, ...rest } = props;
    ...
    return (
        <div id='suffix-input' className='flex flex-col w-full gap-2 relative'>
            ...
            <p ref={suffixRef} className={`absolute z-[2] bottom-[20px] right-5 text-sm font-normal text-gray-500 text-right ${suffixClassName}`}>{suffix}</p>
        </div>
    )
}